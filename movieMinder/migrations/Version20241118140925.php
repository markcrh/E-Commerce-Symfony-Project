 ...
 */
final class Version20241118140925 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE movie (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(255) NOT NULL, year INT NOT NULL, duration INT NOT NULL, synopsis LONGTEXT NOT NULL, poster LONGTEXT NOT NULL, trailer LONGTEXT DEFAULT NULL, rating INT DEFAULT NULL, platforms VARCHAR(500) DEFAULT NULL, watched TINYINT(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
